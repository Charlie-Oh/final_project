   ...
   <section id="body_css">
      <section id="writeForm">
         <div class="contents_join">
            <form name="joinform" action="userJoinByKakao" method="post" class="form_section_join">
            ...
            <table class="join_info_table">
               ...
               <tr>
                  <td>
                     <input type="hidden" name="user_id" id="user_id" class="check join_id_input" value="${user_id }">
                  </td>
               </tr>
               ...
               <tr>
                  ...
                  <td class="td_right">
                     ...
                     <input type="text" id="sample6_address" name="user_addr2" placeholder="주소" readonly required><br> 
               ...
               <tr>
                  ...
                  <td class="td_right">
                     <input name="user_email" type="text" id="emailText" value="${user_email }" class="check" readonly>
                     <p class="info_ptag"></p>
                  </td>
               </tr>
               ...
               $.ajax({
                  ...
                  success: function(data) {
                     if (data.check == "success") { //controller에서 넘겨준 성공여부 코드
                     	...
                     	alert("인증에 실패했습니다.<br> 입력된 전화번호나 인증번호에 오차가 없는지 확인해주세요.");
                     }
                  },
                  error: function(request, status) {
                     alert("오류가 발생했습니다.");
